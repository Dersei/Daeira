...
namespace Daeira
{
    public readonly struct Float4Sse : IEquatable<Float4Sse>, IFormattable
    {
        ...
        public Float4Sse(Float3 value, float w) : this(value.X, value.Y, value.Z, w)
        {
        }

        public Float4Sse(Float2 value1, Float2 value2) : this(value1.X, value1.Y, value2.X, value2.Y)
        {
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Float4Sse operator *(Float4Sse v, float scalar)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Float4Sse operator *(float scalar, Float4Sse v)
        {
            var scalarVector = Vector128.Create(scalar);
        ...
        public static bool Equals(Float4Sse left, Float4Sse right)
        {
            return SimdExtensions.Equal(left.Vector, right.Vector);
        }

        public static bool FloatEquals(Float4Sse left, Float4Sse right)
        {
        ...
        public static Float4Sse Normalize(Float4Sse vector)
        {
        ...
        {
            return Sse41.DotProduct(Vector, v.Vector, 255).GetElement(0);
        }

        // [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float Dot(Float4Sse a, Float4Sse b)
        {
            return Sse41.DotProduct(a.Vector, b.Vector, 255).GetElement(0);
        }
        ...
        public static float Distance(Float4Sse a, Float4Sse b)
        {
            var diff = Sse.Subtract(a.Vector, b.Vector);
            return Sse.SqrtScalar(Sse41.DotProduct(diff, diff, 0b11110001)).GetElement(0);
        }

        public static float DistanceSquared(Float4Sse a, Float4Sse b)
        {
            var diff = Sse.Subtract(a.Vector, b.Vector);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Float4Sse Clamp(Float4Sse value, Float4Sse min, Float4Sse max)
        {
        ...
        public static implicit operator (float x, float y, float z, float w)(Float4Sse v) => (v.X, v.Y, v.Z, v.W);
